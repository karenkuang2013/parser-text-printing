...
public class TokenType {
    ...
    public TokenType() {
     ...
     tokens.put(Tokens.INTeger, Symbol.symbol("intNumber",Tokens.INTeger));
     ...
     tokens.put(Tokens.FloatNumber, Symbol.symbol("<floatnumber>",Tokens.FloatNumber));
     tokens.put(Tokens.scientificN, Symbol.symbol("scientificN",Tokens.scientificN));
     tokens.put(Tokens.SciN, Symbol.symbol("<scientificnumber>",Tokens.SciN));
